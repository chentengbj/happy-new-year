// data.js - 新闻数据
// 2025年第四季度（10月-12月）教培行业动向信息
// 注意：所有信息均来自真实来源，可通过"查看原文"验证
// 已优化：每周每个公司2-3条新闻 + 3-5条招聘信息
console.log('📦 data.js 开始执行...');
const newsData = [
    {
        "week": "2025年第40周 (9月29日-10月5日)",
        "news": [
            {
                "type": "新闻",
                "company": "好未来",
            ...
            },
            {
                ...
                "date": "2025-10-05",
                "source": "https://www.zhipin.com/web/geek/job?query=猿辅导+前端开发工程师"
            },
            {
                "type": "招聘",
                "company": "猿辅导",
...
if (typeof window !== 'undefined') {
    window.newsData = newsData; // 确保在window对象上也可访问
    console.log('✅ newsData已挂载到window对象');
}
